...
| `%%✅ oui%%` | Quick reply — one keystroke | Emoji verdict inline |
...
| `acemd.quickNotes` | `o ✅ oui`, `k 👍 ok`, `n ❌ non`, `r 🔁 reformule plus clairement` | One-keystroke canned comments: `key`, `emoji`, `text` per entry |
